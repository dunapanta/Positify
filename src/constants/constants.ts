...
let onBoardQuestions: OnBoardQuestionsInterface[] = [
    {
        ...
        options: [
            ...
            {
                id: 5,
                text: "onboarding.question1Option5",
                hasImage: false,
                isMultiipleAnswer: false,
            },
        ],
    ...
    },
    {
        ...
        options: [
            ...
            {
                id: 6,
                text: "onboarding.question4Option6",
                hasImage: true,
            ...
            {
                id: 7,
                text: "onboarding.question4Option7",
                hasImage: true,
            ...
            {
                id: 8,
                text: "onboarding.question4Option8",
                hasImage: true,
    ...
    {
        id: 5,
        question: "onboarding.question5",
        options: [
            {
                id: 1,
                text: "onboarding.question5Option1",
                hasImage: true,
            ...
            {
                id: 2,
                text: "onboarding.question5Option2",
                hasImage: true,
            ...
            {
                id: 3,
                text: "onboarding.question5Option3",
                hasImage: true,
            ...
            {
                id: 4,
                text: "onboarding.question5Option4",
                hasImage: true,
            ...
            {
                id: 5,
                text: "onboarding.question5Option5",
                hasImage: true,
